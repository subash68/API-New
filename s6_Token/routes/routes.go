...
import (
	...
	"github.com/jaswanth-gorripati/PGK/s6_Token/controllers"
	"github.com/jaswanth-gorripati/PGK/s6_Token/middleware"
)
...
func InitialzeRoutes() *gin.Engine {
	...
	token := router.Group("/t")
	token.Use(middleware.AuthorizeRequest())
