...
import (
	...
	"github.com/jaswanth-gorripati/PGK/s7_PaymentGateway/controllers"
...
func InitialzeRoutes() *gin.Engine {
	...
	paymentGateway := router.Group("/pg")

	paymentGateway.POST("createPayment", middleware.AuthorizeRequest(), controllers.CreateOrder)

	paymentGateway.POST("verifyPayment", middleware.AuthorizeRequest(), controllers.ValidatePayment)
