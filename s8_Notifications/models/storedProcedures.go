...
func CreateSP() {
	...
	SP = map[string]string{
		"NFT_INS":             "INSERT INTO " + dbConfig.DbDatabaseName + "." + dbConfig.NotificationsDbName + "(Notification_ID,Initiator_Stakeholder_ID,SenderUserRole,Receiver_Stakeholder_ID,DateofNotification,NotificationType,Notification_Content,Notification_AttachFile,RedirectedURL,Publish_ID,PublishFlag,CreationDate,LastUpdatedDate) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)",
