...
import (
	...
	"github.com/jaswanth-gorripati/PGK/s8_Notifications/controllers"
	"github.com/jaswanth-gorripati/PGK/s8_Notifications/middleware"
)
...
func InitialzeRoutes() *gin.Engine {
	...
	notifications := router.Group("/nft")
	notifications.Use(middleware.AuthorizeRequest())
